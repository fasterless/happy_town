...
export const levels = [
  ...
  { level: 4, needExp: 150, unlock: "草莓、许愿池、称号与头像框、关系收藏" },
  { level: 5, needExp: 250, unlock: "好友拜访、小镇委托榜、邻居求助板、天赋树、邻居每日日程、邻居关系、邻居回忆" },
  { level: 6, needExp: 400, unlock: "玉米、料理铺（田园沙拉）、周边探索" },
